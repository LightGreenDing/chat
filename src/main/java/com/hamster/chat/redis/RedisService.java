...
public interface RedisService<K, V> {
    ...
    String getMapFieldToString(K key, K field);
    ...
    /**
     * 通过key想获取的条数获取对应的List
     *
     * @param key
     * @param size 条数
     * @return
     */
    List<V> getList(K key, int size);
...
//     * 缓存彩种信息
//     */
//    void makeLotteryType();
//
//    void makeIpaddress();
//
//    void makeSensitiveWord();
//
//    void makeBannedUser();
//
//    /**
...
//     * @param tenantCode
//     */
//    void makeBannedUserByTenantCode(String tenantCode);
//
//    void redisRefreshC();
//
//    void makeSystemCfg();
